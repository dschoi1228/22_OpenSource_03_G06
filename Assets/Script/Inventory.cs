...
public class Inventory : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        for (int y = 0; y < 5; y++)
        {
            ...
            // 슬롯의 사이즈 설정하기.
            mission.SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, slotSize - slotSize * 0.3f); // 가로.
            mission.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, slotSize - slotSize * 0.3f);   // 세로.
